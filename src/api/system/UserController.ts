...
export default class SystemUserController extends BaseController {
  ...
  static listSysPermWithDetail(params: ANY_OBJECT, httpOptions?: RequestOption) {
    return super.get<TableData<Perm>>(API_CONTEXT + "/upms/sysUser/listSysPermWithDetail", params, httpOptions);
  }

  static listSysPermCodeWithDetail(params: ANY_OBJECT, httpOptions?: RequestOption) {
    return super.get<TableData<PermCode>>(API_CONTEXT + "/upms/sysUser/listSysPermCodeWithDetail", params, httpOptions);
  }

  static listSysMenuWithDetail(params: ANY_OBJECT, httpOptions?: RequestOption) {
    return super.get<TableData<MenuItem>>(API_CONTEXT + "/upms/sysUser/listSysMenuWithDetail", params, httpOptions);
  }
}
